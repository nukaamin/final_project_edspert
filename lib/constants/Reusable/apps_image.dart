class AssetSetting {
  String imgLogin = "assets/login/img_login.png";
  String icSplash = "assets/login/ic_edspert.png";
  String icGoogle = "assets/login/ic_google.png";
  String icAple = "assets/login/ic_apple.png";
